...
public class XFProgressBar extends View {
	...
	public XFProgressBar(Context context, AttributeSet attrs){
		this(context, attrs, 0);
	}
	
	public XFProgressBar(Context context, AttributeSet attrs, int defStyle){
		...
		TypedArray ta = context.obtainStyledAttributes(attrs, R.styleable.XFProgressBar);
		
		color = ta.getColor(R.styleable.XFProgressBar_android_color, 0x0);
		
		ta.recycle();
		
        progressBarHeight = context.getResources().getDimensionPixelOffset(R.dimen.widget_xfprogressbar_height);
